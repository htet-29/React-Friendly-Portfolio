...
const LatestPosts = ({ posts, limit = 3 }: LatestPostsProp) => {
    ...
    <section className="mx-auto max-w-6xl px-6 py-12">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {latest.map((post) => (
          ...
          >
            <h3 className="mb-1 text-lg font-semibold text-blue-400">{post.title}</h3>
            <p className="text-sm text-gray-300">{post.slug}</p>
